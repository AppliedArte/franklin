    ...
    <div className="min-h-screen bg-ivory-100 grain">
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-8 pt-32 pb-24">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-body text-lg text-silver-700/60 mb-8">Your AI Private Banker (Est. 1706)</p>
        ...
        <Section title="Professional Summary">
          <p className="font-body text-silver-700/80 leading-relaxed">
        ...
        <Section title="Professional Experience">
          {/* Current Role */}
          <div className="mb-8 pb-8 border-b border-silver-700/10">
            <div className="flex flex-wrap justify-between items-baseline gap-2 mb-2">
              <h3 className="font-display text-xl text-silver-700">Chief Intelligence Officer</h3>
              <span className="text-sm text-silver-700/50">2024 - Present</span>
            </div>
            <p className="text-gold-500 text-sm mb-4">askFranklin.xyz</p>
            <ul className="space-y-2 text-silver-700/70 text-sm list-disc list-outside ml-5">
          ...
          <div className="mb-8 pb-8 border-b border-silver-700/10">
            <div className="flex flex-wrap justify-between items-baseline gap-2 mb-2">
              <h3 className="font-display text-xl text-silver-700">Founding Father & Private Banker</h3>
              <span className="text-sm text-silver-700/50">1706 - 2024</span>
            </div>
          ...
          <div>
            <div className="flex flex-wrap justify-between items-baseline gap-2 mb-2">
              <h3 className="font-display text-xl text-silver-700">Ambassador to France</h3>
              <span className="text-sm text-silver-700/50">1776 - 1785</span>
            </div>
        ...
        <Section title="Languages">
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <span key={i} className="px-4 py-2 text-sm text-silver-700 border border-silver-700/20 bg-ivory-50">
                {lang}
              </span>
            ))}
          </div>
        ...
        <div className="mb-12 p-8 border-l-4 border-gold-400 bg-ivory-50">
          <h2 className="font-display text-2xl text-silver-700 mb-4">Investment Philosophy</h2>
          <blockquote className="font-body italic text-silver-700/80 text-lg leading-relaxed">
        ...
        {/* Footer */}
        <p className="text-center mt-12 text-silver-700/50 text-sm italic">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="mb-12 p-8 border border-silver-700/10 bg-ivory-50">
      <h2 className="font-display text-2xl text-silver-700 mb-6">{title}</h2>
      {children}
    </div>
  )
}
